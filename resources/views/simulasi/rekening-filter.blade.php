...
<!-- 🔍 Form Pencarian -->
<div class="mb-3">
    <input type="text" id="filterNamaRekening" class="form-control" placeholder="Cari Nama Rekening">
    <button id="btnFilter" class="btn btn-primary mt-2">Cari</button>
</div>
    ...
    <table id="rekapTable" class="table table-bordered">
        <thead class="table-dark">
            <tr>
                ...
                <th class="text-end">Total Rekening OPD</th>
...
<script>
  ...
  function exportToPDF() {
    ...
    doc.setFontSize(12);
    doc.text("Rekap Rekening Per OPD", 14, 10);
    ...
    // 🔥 Simpan PDF
    doc.save("rekap_rekening_opd.pdf");
}
...
$("#btnFilter").click(function () {
            let namaRekening = $("#filterNamaRekening").val();
            window.location.href = `?nama_rekening=${namaRekening}`;
        });
</script>
