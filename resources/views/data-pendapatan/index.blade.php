...
@section('page-title', 'Data Pendapatan')
    ...
    <div class="mt-4 row">
        <div class="col-12">
            <div class="border-0 shadow-lg card" data-aos="fade-up" data-aos-delay="200">
                <div class="card-body">
                    <h5 class="card-title"><i class="bi bi-table"></i> Data Pendapatan</h5>
                    <div class="mb-3">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#uploadModal">
                            <i class="bi bi-cloud-upload-fill"></i> Upload Data Pendapatan
                        </button>
                    </div>
                    <div class="table-responsive">
                        <table id="pendapatanTable" class="table table-sm table-bordered">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Tipe Data</th>
                                ...
                                @foreach ($pendapatans as $data)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form id="delete-form-{{ $data->tahapan_id }}-{{ $data->tanggal_upload }}-{{ $data->jam_upload }}" action="{{ route('data-pendapatan.destroy', [$data->tahapan_id, $data->tanggal_upload, $data->jam_upload]) }}" method="POST" style="display:none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="uploadModalLabel">Upload Data Pendapatan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('data-pendapatan.upload') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="alert alert-info">
                        ...
                        <ul>
                            ...
                            <li><strong>KODE AKUN</strong> - Kode akun pendapatan</li>
                            <li><strong>NAMA AKUN</strong> - Nama akun pendapatan</li>
                            <li><strong>KODE OPD</strong> - Kode OPD</li>
                            <li><strong>NAMA OPD</strong> - Nama OPD</li>
                            <li><strong>URAIAN</strong> - Uraian pendapatan</li>
                            <li><strong>KETERANGAN</strong> - Keterangan (opsional)</li>
                            <li><strong>PAGU</strong> - Pagu pendapatan (numeric)</li>
                        </ul>
                    </div>
